package com.example.emailservicenov24.consumers;

import com.example.emailservicenov24.dtos.SendEmailDto;
import com.example.emailservicenov24.utils.EmailUtil;
    ...
    public void handleSendEmailEvent(String message) throws JsonProcessingException {
        ...
        Authenticator auth = new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("t09153137@gmail.com", "vlfdceahbfhwnimi");
            }
        };
